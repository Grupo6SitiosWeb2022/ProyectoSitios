        ...
        <div class="contenedor">
            <div  class="GraficosContenedor">
                <div class="PanelAD">
                    ...
                    <div class="grafico1">
                        <br />
                        <h1>Créditos más populares</h1>
                        <br />
                        <br />
                        <asp:Chart runat="server" ID="chartclic" BackColor="Transparent" Palette="Chocolate">
                                    <Legends>  
            <asp:Legend Alignment="Center" Docking="Bottom" IsTextAutoFit="False" Name="Default"  
                LegendStyle="Row" />  
        </Legends>
                            <series>
                                <asp:Series Name="serieclic" ChartType="Pie"></asp:Series>

                            </series>
                            <chartareas>
                                <asp:ChartArea Name="chartareaclic"></asp:ChartArea>
                     ...
                     <div class="grafico1">
                         <br />
                        <h1>Posicionamiento de puntero por más de 5 segundos</h1>
                         <br />
                         <asp:Chart ID="chartSeg" runat="server" BackColor="Transparent" Palette="Chocolate" BorderlineColor="Transparent">
                                     <Legends>  
            <asp:Legend Alignment="Center" Docking="Bottom" IsTextAutoFit="False" Name="Default" 
                LegendStyle="Row" />  
        </Legends>
                             <Series>
                                 <asp:Series Name="serieseg" ChartType="Pie"></asp:Series>
                             </Series>
                             <ChartAreas>
                                 <asp:ChartArea Name="chartareaseg"></asp:ChartArea>
                             </ChartAreas>
                         </asp:Chart>
                    </div>
                    <div class="grafico1">
                        <br />
                        <h1>Usuarios autenticados y no autenticados</h1>
                        <br />
                        <asp:Chart ID="chartau" runat="server" BackColor="Transparent" Palette="Chocolate">
        ...
        <Legends>  
            <asp:Legend Alignment="Center" Docking="Bottom" IsTextAutoFit="False" Name="Default"  
                LegendStyle="Row" />  
                            ...
                            <Series>
                                <asp:Series Name="serieau" ChartType="Pie" YValuesPerPoint="6"></asp:Series>
                            </Series>
                            <ChartAreas>
                                <asp:ChartArea Name="chartareaau"></asp:ChartArea>
                            </ChartAreas>
                        </asp:Chart>
                    </div>
                    <br />

...
<body style="width: 100%; margin-left: auto; margin-right: auto;">
    <form id="form1" runat="server">
        ...
        <div style="margin-left: auto; margin-right: auto;">
            <h1 style="text-align: center; color: #061738; font-size: 50px; font-weight: bold;">Roles </h1>
            <br />
            <br />
            <div class="HeaderTable" style="">
              ...
              <asp:TextBox ID="txtFiltro" runat="server" CssClass="btnRoles" OnTextChanged="txtFiltro_TextChanged"></asp:TextBox>
                    <p style="display: inline; color: #ee8133; text-align: center;">
                        <asp:Button ID="btnBuscar" runat="server" Text="Buscar" CssClass="RolesButton" OnClick="btnBuscar_Click1" />
                    </p>
        ...
        <div style="width: 90%; text-align: center; align-items: center; margin-left: auto; margin-right: auto;">
            <asp:Table ID="TablaRolesn" runat="server" CssClass="table is-striped" ForeColor="#0B0550" HorizontalAlign="Center" Width="100%" Height="50px">
                <asp:TableHeaderRow ID="Table1HeaderRow" Style="color: white;" CssClass="CabezaTabla" 
                    ForeColor="white"
                    BackColor="#061738"
                    runat="server">
                    <asp:TableHeaderCell ForeColor="#ee8133"
                        Scope="Column"
                        Text="Código" />
                    <asp:TableHeaderCell ForeColor="#ee8133"
                        Scope="Column"
            ...
            <div class="HeaderTable" style="">
              ...
              <asp:TextBox ID="txtNombreRol" runat="server" CssClass="btnRoles"> </asp:TextBox>
                    ...
                    <asp:Button ID="btnAgregar" runat="server" Text="Agregar" CssClass="RolesButton" OnClick="btnAgregar_Click1"  />

                    <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="RolesButton" OnClick="btnModificar_Click"  />

                    <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="RolesButton" OnClick="btnEliminar_Click" />

    ...
    <form id="form1" runat="server">
            ...
            <nav class="navbar" style="z-index: 100; top: 35px; background-color: #061738; color: white" role="navigation" aria-label="dropdown navigation">
                <div class="navbar-menu" style="color: #ee8133;">
                    ...
                    <div class="navbar-end" style="color: white;">
                        <a class="navbar-link" style="color: #ee8133;">Panel de administración
                        </a>
                    </div>
                    <div class="navbar-end">
                        <a class="navbar-link" style="color:#ee8133;;">Estadísticas
                        </a>
                    </div>
                    <div class="navbar-end">
                        <a class="navbar-link" style="color: #ee8133;">Solicitudes
                        </a>
                    </div>
                    <div class="navbar-end">
                        <a class="navbar-link" style="color: #ee8133;">Gestión
                        </a>
                    </div>
                    <div class="navbar-end">
                        <a class="navbar-link" style="color: #ee8133;">Configuración
                        </a>
                    </div>
                </div>
            </nav>
      ...
      <div class="card-content" style="text-align:center">
              <div>
                  ...
                  <h1 style="text-align: center;color:#061738;font-size:50px"> Aprobación de Créditos </h1>
                  ...
                  <h4 style="text-align: center;color:#061738;font-size:20px"> Importante: Recordar las políticas de la empresa para aceptar o denegar solicitudes de créditos. </h4>                  
                  <br />               
              </div>
                ...
                <p style="display:inline;color:#ee8133; text-align:center;">
                    <asp:LinkButton  runat="server" class="button is-info is-outlined" style="width: 220px; height: auto;" OnClick="Unnamed3_Click">

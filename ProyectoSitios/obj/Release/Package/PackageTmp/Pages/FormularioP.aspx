 ...
 <div class="navbar-end">
       ...
       <br><br><br>
            <div style="font-size:medium;color:blue">
              <h1> Formulario de solicitud de préstamos PYMES</h1>
        </div>    
  ...
  <div style="margin-left:40px">
      ...
      <asp:DropDownList ID="ddlTiposIdentificacion" runat="server" CssClass="select.is-info select">
       ...
       <br/>
       <br/>
      <asp:Label ID="lblIdentificacion" runat="server" Text="">Identificación Juridica</asp:Label>
      <br/>
      ...
      <asp:TextBox ID="txtSalario" runat="server"></asp:TextBox>
       ...
       <br/>
       <br/>
       <asp:Button ID="btnFormulario" runat="server" Text="Formulario " class="button is-info is-outlined" style="width:200px;" OnClick="btnFormulario_Click"/>
      </div>
      </div>
      </div>
